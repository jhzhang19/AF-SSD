...
class Points_Sampler(nn.Module):
    ...
    def forward(self, points_xyz, features):
        ...
        for fps_sample_range, sampler, npoint in zip(
            ...
            # print("start last:", last_fps_end_index)
            ...
            # print("*"*18)
            # print("npoint:", npoint)
            # print("sample_points_xyz.shape", sample_points_xyz.shape)
            ...
            # if(npoint==512):
            #   print("fps_idx", fps_idx[:,0:256])
            #   print("fps_idx", fps_idx[:,512:768])
            indices.append(fps_idx + last_fps_end_index)
            # print("indices:",len(indices[0]))
            # print("fps_sample_range", fps_sample_range)
            last_fps_end_index += fps_sample_range
            # print("last_end_index:", last_fps_end_index)
            # print("*"*18)
