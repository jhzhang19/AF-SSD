...
class DynamicVFE(nn.Module):
    ...
    def forward(self,
        ...
        # print("end features shape:", features.shape)
        # print("coor.shape", coors.shape)
        # print(coors)
        # print("#"* 20)
        # print("image_feature_from_neck length:", len(img_feats))
        # print(img_feats[0].shape, img_feats[1].shape, img_feats[2].shape, img_feats[3].shape, img_feats[4].shape)
        # print("#"* 20)
