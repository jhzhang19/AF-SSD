...
class FusionSSD3DNet(VoteNet):
    ...
    def forward_train(self,
        ...
        # print("point_cat shape:", points_cat.shape)
    ...
    def simple_test(self, points, img_metas, img=None, rescale=False):
        ...
        # print("feature extract time is: ", feature_ext_time-feature_start)
        # print("head time is: ", head_time-head_start)
        # print("point_cat time is:", point_cat_time-start_time)
